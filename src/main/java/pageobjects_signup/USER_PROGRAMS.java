...
public class USER_PROGRAMS {
	...
	public static String elementMap(String xpath_name) {
		...
		userProgramsElements.put("checkboxAUTOMATEDALUMNAPUBLICPROGRAM", "//span[text()=' Automated Alumna Public Program']");
		...
		userProgramsElements.put("inputNUMBERPROGRAMQUESTION", "//input[@placeholder='Number Program Question Placeholder']");
		userProgramsElements.put("inputTEXTPROGRAMQUESTION", "//input[@placeholder='Text Program Question Placeholder']");
